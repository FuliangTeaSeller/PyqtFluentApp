...
class Func1Widget(QFrame, Ui_Form):
    ...
    def Jsme(self):
        ...
        self.web_view.setMinimumSize(800, 350)
        ...
        # 设置定时器来定期获取 SMILES 字符串
        self.timer = QTimer(self)
        self.timer.timeout.connect(self.fetchSmiles)
        self.timer.start(1000)  # 每1秒获取一次
        
    
    def fetchSmiles(self):
        # 执行 JavaScript 代码获取 SMILES 字符串
        self.web_view.page().runJavaScript("jsmeApplet.smiles();", self.processSmiles)

    def processSmiles(self, smiles):
        # print("Current SMILES:", smiles)
        pass
