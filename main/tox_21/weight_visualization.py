...
def weight_visulize_py(smiles, atom_weight,label):
    print(smiles)
    ...
    MolToFile(mol, r'./'+smiles_name+label+'.png', highlightAtoms=significant_fg_index, highlightBonds=significant_bond_index,
              highlightAtomColors=atom_colors, highlightBondColors=bond_colors)
